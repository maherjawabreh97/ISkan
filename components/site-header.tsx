      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-5 px-5 sm:px-8">
        ...
        <div className="flex items-center gap-2.5">
          <a
            ...
            className="hidden items-center gap-2 rounded-full bg-gold-400/15 px-5 py-2 text-sm font-bold text-gold-300 ring-1 ring-gold-400/25 transition hover:bg-gold-400 hover:text-ink-950 hover:ring-gold-400 lg:inline-flex"
          >
